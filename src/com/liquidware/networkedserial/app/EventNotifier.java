...
public class EventNotifier {
    ...
    public synchronized void onSocketDataReceived(String msg){
        enterList();
        for (Event listener : listeners)
            listener.onSocketDataReceived(msg);
        exitList();
    }

    public synchronized void onSocketDataTransmit(String msg){
        enterList();
        for (Event listener : listeners)
            listener.onSocketDataTransmit(msg);
        exitList();
    }
}
